 ...
 */
final class Version20180620093650 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE task (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, street VARCHAR(255) NOT NULL, house_number VARCHAR(32) NOT NULL, post_code VARCHAR(64) NOT NULL, place VARCHAR(64) NOT NULL, task VARCHAR(64) NOT NULL, valuation VARCHAR(64) DEFAULT NULL, published_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, INDEX IDX_527EDB25A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
